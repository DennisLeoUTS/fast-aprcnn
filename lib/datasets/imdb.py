...
class imdb(object):
    ...
    def create_roidb_from_box_list(self, box_list, gt_roidb):
        ...
        for i in xrange(self.num_images):
            ...
            if self.name.startswith('cub') or self.name.startswith('nabirds'):
                overlaps = np.zeros((num_boxes, self.num_parts), dtype=np.float32)
            else:
            ...
            if gt_roidb is not None:
                ...
                overlaps[I, gt_classes[argmaxes[I]]-1] = maxes[I]
